...
void goToStart() {
    DMANow(3, magentaPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, magentaTiles, &((charblock *)0x6000000)[0], 64 / 2);
    DMANow(3, magentaMap, &((screenblock *)0x6000000)[28], 1024 * 4);
...
void goToGame() {
    DMANow(3, bluePal, ((unsigned short *)0x5000000), 256);
    DMANow(3, blueTiles, &((charblock *)0x6000000)[0], 64 / 2);
    DMANow(3, blueMap, &((screenblock *)0x6000000)[28], 1024 * 4);
...
void goToPause() {
    DMANow(3, greenPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, greenTiles, &((charblock *)0x6000000)[0], 32 / 2);
    DMANow(3, greenMap, &((screenblock *)0x6000000)[28], 1024 * 4);
...
void goToWin() {
    DMANow(3, yellowPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, yellowTiles, &((charblock *)0x6000000)[0], 64 / 2);
    DMANow(3, yellowMap, &((screenblock *)0x6000000)[28], 1024 * 4);
...
void goToLose() {
    DMANow(3, redPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, redTiles, &((charblock *)0x6000000)[0], 64 / 2);
    DMANow(3, redMap, &((screenblock *)0x6000000)[28], 1024 * 4);
